...
function PhoneStatusBar() {
  return (
    <div className="flex items-center justify-between px-5 pt-[14px] pb-1 text-white">
      <span className="text-[10.5px] font-bold tracking-tight">9:41</span>
      <div className="flex items-center gap-[5px]">
        <svg viewBox="0 0 16 12" fill="white" className="h-2.5 w-3.5">
          <rect x="0" y="7" width="3" height="5" rx="0.4" />
          <rect x="4.5" y="4.5" width="3" height="7.5" rx="0.4" />
          <rect x="9" y="2" width="3" height="10" rx="0.4" />
          <rect x="13.5" y="0" width="2.5" height="12" rx="0.4" opacity="0.25" />
        </svg>
        <svg viewBox="0 0 20 14" fill="white" className="h-2.5 w-3.5">
          <path d="M10 2.5C7 2.5 4.3 3.7 2.4 5.7L0 3.3C2.5 1.2 5.6 0 10 0s7.5 1.2 10 3.3l-2.4 2.4C15.7 3.7 13 2.5 10 2.5z" opacity="0.3" />
          <path d="M10 6c-2 0-3.8.8-5 2.1L2.7 5.8C4.4 4 7.1 3 10 3s5.6 1 7.3 2.8L15 8.1C13.8 6.8 12 6 10 6z" opacity="0.6" />
          <path d="M10 9.5c-1.1 0-2.1.5-2.8 1.2L5.3 8.8C6.5 7.7 8.2 7 10 7s3.5.7 4.7 1.8l-1.9 1.9C12.1 10 11.1 9.5 10 9.5z" />
          <circle cx="10" cy="13" r="1.5" />
        </svg>
        <svg viewBox="0 0 26 13" fill="none" className="h-2.5 w-4">
          <rect x="0.75" y="0.75" width="21.5" height="11.5" rx="2.5" stroke="white" strokeWidth="1.5" strokeOpacity="0.35" />
          <rect x="2.5" y="2.5" width="16" height="8" rx="1.5" fill="white" />
          <path d="M23.5 4.5v4a2.3 2.3 0 0 0 0-4z" fill="white" fillOpacity="0.5" />
        </svg>
      </div>
    </div>
  );
...
function PhoneNav({ active }: { active: "feed" | "search" | "msg" | "bell" | "profile" }) {
  const items = [
    {
      id: "feed", icon: (
        <svg viewBox="0 0 24 24" className="h-[22px] w-[22px]" fill="none" strokeWidth="2">
  ...
  return (
    <div className="absolute inset-x-0 bottom-0 border-t border-white/[0.08] bg-[#111113]/95 backdrop-blur-sm">
      <div className="flex items-center justify-around px-3 py-2.5 pb-4">
        {items.map((item) => {
          ...
          return (
            <div
              ...
              style={{
                ...
                stroke: isActive ? "#3b82f6" : "rgba(255,255,255,0.28)",
